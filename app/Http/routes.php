...
Route::get('/license', 'LoginController@license');
...
Route::group(array('middleware' => 'web'), function() {
    ...
    Route::get('/dashboard/teacherList', 'DashboardController@teacherList');
    Route::get('/dashboard/teacherClassesList', 'DashboardController@teacherClassesList');
    Route::get('/dashboard/classSubjectsList', 'DashboardController@classSubjectsList');
    ...
    //Agenda
    Route::get('/agenda', 'DashboardController@index');
    Route::get('/agenda/{date}', 'AgendaController@list');
    Route::post('/agenda/markasdone/{id}', 'AgendaController@markasdone');
    ...
    Route::get('/teachers/exportp', 'TeachersController@exportpdf');
    ...
    Route::get('/students/getMarksheets', 'StudentsController@getMarksheets');
    Route::get('/students/marksheets/{id}', 'StudentsController@marksheets');
    Route::get('/students/marksheetsPDF/{id}', 'StudentsController@marksheetsPDF');
    ...
    Route::get('/students/exportp' , 'StudentsController@exportpdf');
    ...
    Route::get('/parents/exportp', 'ParentsController@exportpdf');
    ...
    Route::get('/subjects/preview/{id}', 'SubjectsController@preview');
    ...
    Route::get('/overview/details/{id}', 'OverviewController@details');
    Route::get('/overview/post/{id}', 'OverviewController@post');
    Route::get('/overview/lectures/{id}', 'OverviewController@lectures');
    Route::get('/overview/lectures/play/{id}', 'OverviewController@playLecture');
    Route::post('/overview/lecture', 'OverviewController@createLecture');
    Route::get('/overview/editLecture/{id}', 'OverviewController@fetchLecture');
    Route::post('/overview/editLecture/{id}', 'OverviewController@editLecture');
    Route::post('/overview/deleteLecture/{id}', 'OverviewController@deleteLecture');
    Route::get('/overview/content/{id}', 'OverviewController@content');
    Route::post('/overview/material', 'OverviewController@createMaterial');
    Route::get('/overview/editMaterial/{id}', 'OverviewController@fetchMaterial');
    Route::post('/overview/editMaterial/{id}', 'OverviewController@editMaterial');
    Route::post('/overview/deleteMaterial/{id}', 'OverviewController@deleteMaterial');
    
    Route::post('/overview/assignments', 'OverviewController@createAssignment');
    Route::get('/overview/assignments/{id}', 'OverviewController@assignments');
    Route::get('/overview/editAssignment/{id}', 'OverviewController@fetchAssignment');
    Route::post('/overview/editAssignment/{id}', 'OverviewController@editAssignment');
    Route::post('/overview/deleteAssignment/{id}', 'OverviewController@deleteAssignment');
    Route::get('/overview/downloadAssignment/{id}', 'OverviewController@downloadAssignment');
    Route::get('/overview/downloadAssignmentAnswer/{id}', 'OverviewController@downloadAssignmentAnswer');
    Route::post('/overview/checkAssignmentUpload', 'OverviewController@checkAssignmentUpload');
    Route::get('/overview/listAssignmentAnswers/{id}', 'OverviewController@listAssignmentAnswers');
    Route::post('/overview/uploadAssignment/{id}', 'OverviewController@uploadAssignment');
    
    Route::get('/overview/quizzes/{id}', 'OverviewController@quizzes');
    Route::post('/overview/quiz', 'OverviewController@createQuiz');
    Route::get('/overview/editQuiz/{id}', 'OverviewController@fetchQuiz');
    Route::post('/overview/editQuiz/{id}', 'OverviewController@editQuiz');
    Route::post('/overview/deleteQuiz/{id}', 'OverviewController@deleteQuiz');
    Route::get('/overview/quizQuestions', 'OverviewController@quizQuestions');
    Route::get('/overview/quizQuestions/{id}', 'OverviewController@fetchQuizQuestions');
    Route::get('/overview/searchQuestion/{keyword}', 'OverviewController@searchQuizQuestion');
    Route::post('/overview/quizQuestions/{id}', 'OverviewController@editQuizQuestions');
    Route::post('/overview/quizQuestions/delete/{id}', 'OverviewController@deleteQuizQuestions');
    Route::post('/overview/quizQuestions', 'OverviewController@createQuizQuestions');
    Route::post('/overview/takeQuiz/{id}', 'OverviewController@takeQuiz');
    Route::post('/overview/tookQuiz/{id}', 'OverviewController@tookQuiz');
    Route::get('/overview/quizMarks/{id}', 'OverviewController@quizMarks');
    Route::get('/overview/exportQuiz/{id}/{type}', 'OverviewController@exportQuiz');
    
    Route::get('/overview/gradeItems/{id}', 'OverviewController@gradeItems');
    Route::post('/overview/gradeItemNotify/{id}', 'OverviewController@gradeItemNotifications');
    Route::post('/overview/gradeItem', 'OverviewController@createGradeItem');
    Route::get('/overview/gradeItem/{id}', 'OverviewController@fetchGradeItem');
    Route::post('/overview/getGradeItemMarks', 'OverviewController@fetchGradeItemMarks');
    Route::post('/overview/gradeItem/{id}', 'OverviewController@editGradeItem');
    Route::post('/overview/deleteGradeItem/{id}', 'OverviewController@deleteGradeItem');
    Route::post('/overview/saveGradeItemMarks/{item}/{class}/{subject}', 'OverviewController@saveGradeItemMarks');
    
    //courses
    Route::get('/courses', 'DashboardController@index');
    Route::get('/courses/{id}', 'CoursesController@overview');
    ...
    Route::get('/classschedule/period/{id}', 'ClassScheduleController@fetchPeriod');
    Route::post('/classschedule/period/{id}', 'ClassScheduleController@editPeriod');
    Route::post('/classschedule/delete/{class}/{id}', 'ClassScheduleController@delete');
    Route::post('/classschedule/deletePeriod/{id}', 'ClassScheduleController@deletePeriod');
    Route::post('/classschedule/period', 'ClassScheduleController@addPeriod');
    ...
    //Grade Items
    Route::get('/gradeItems', 'DashboardController@index');
    Route::get('/gradeItems/listAll', 'GradeItemsController@listAll');
    Route::post('/gradeItems/notify/{id}', 'GradeItemsController@notifications');
    Route::post('/gradeItems', 'GradeItemsController@create');
    Route::get('/gradeItems/{id}', 'GradeItemsController@fetch');
    Route::post('/gradeItems/getMarks', 'GradeItemsController@fetchMarks');
    Route::post('/gradeItems/{id}', 'GradeItemsController@edit');
    Route::post('/gradeItems/delete/{id}', 'GradeItemsController@delete');
    Route::post('/gradeItems/saveMarks/{item}/{class}/{subject}', 'GradeItemsController@saveMarks');


    //Lecturs
//    Route::get('/lectures', 'DashboardController@index');
//    Route::get('/lectures/offline', 'LecturesController@offline');
//    Route::get('/lectures/online', 'LecturesController@online');
    Route::get('/lectures', 'DashboardController@index');
    Route::get('/lectures/listClasses', 'LecturesController@listClasses');
    Route::get('/lectures/listAll', 'LecturesController@listAll');
    Route::post('/lectures', 'LecturesController@create');
    Route::get('/lectures/{id}', 'LecturesController@fetch');
    Route::post('/lectures/delete/{id}', 'LecturesController@delete');
    Route::post('/lectures/fe_active/{id}', 'LecturesController@fe_active');
    Route::post('/lectures/{id}', 'LecturesController@edit');
    Route::get('/lectures/play/{id}', 'LecturesController@play');
    Route::get('/lectures/classSubjects/{id}', 'LecturesController@classSubjects');
    Route::get('/lectures/subjectLectures/{id}', 'LecturesController@subjectLectures');
    Route::get('/lectures/play/{id}', 'LecturesController@subjectLectures');
