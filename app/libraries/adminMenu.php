...
$menu = array(
    ...
    "school" => array("title" => "School", "icon" => "mdi mdi-briefcase",
        "children" => array(
            ...
            "students" => array("title" => "Students", "url" => URL::to('portal#/students'), "role_perm" => array("Incomes.list"), "icon" => "mdi mdi-chart-areaspline", "activated" => "reportsAct"),
            "employees" => array("title" => "Employees", "url" => URL::to('portal#/employees'), "role_perm" => array("Incomes.list"), "icon" => "mdi mdi-chart-areaspline", "activated" => "reportsAct"),
            ...
            "library" => array("title" => "Library", "url" => URL::to('portal#/library'), "role_perm" => array("Incomes.list"), "icon" => "mdi mdi-chart-areaspline", "activated" => "reportsAct"),
...
//            "inventory" => array("title" => "Inventory", "url" => URL::to('portal#/#'), "role_perm" => array("Incomes.list"), "icon" => "mdi mdi-chart-areaspline", "activated" => "reportsAct"),
        )
    ),
    "adminpanel" => array("title" => "Admin Panel", "icon" => "mdi mdi-message-text-outline",
        "children" => array(
            "administrative_tasks" => array("title" => "Administrative Tasks", "url" => URL::to('portal#/settings'), "icon" => "mdi mdi-message-text-outline", "activated" => "messagesAct", "role_perm" => array("Messages.list")),
            "cms" => array("title" => "CMS", "url" => URL::to('portal#/frontend/settings'), "role_perm" => array('mailsms.mailSMSSend'), "icon" => "mdi mdi-cellphone-iphone", "activated" => "mailSmsAct")//,
          //  "setup" => array("title" => "Setup", "url" => URL::to('portal#/#'), "role_perm" => array("mobileNotifications.sendNewNotification"), "icon" => "mdi mdi-telegram", "activated" => "sendNotifAct"),
        )
    ),
    "schedule" => array("title" => "Schedule", "icon" => "mdi mdi-calendar-clock",
        "children" => array(
//            "agenda" => array("title" => "Agenda", "url" => URL::to('portal#/#'), "role_perm" => array("studyMaterial.list", "homework.list", "assignments.list"), "icon" => "mdi mdi-chart-areaspline", "activated" => "reportsAct"),
...
//    "cms" => array("title" => "CMS", "icon" => "mdi mdi-book-multiple",
//        "children" => array(
...
//    ),
    #"agreement" => array("title" => "Agreement", "icon" => "mdi mdi-book-multiple",
     #   "children" => array(
         #   "health" => array("title" => "Health & Safety", "url" => URL::to('portal#/#'), "role_perm" => array("frontendCMSpages.list", "frontendCMSpages.addPage", "frontendCMSpages.editPage", "frontendCMSpages.delPage")),
          #  "dress_code" => array("title" => "Dress Code", "url" => URL::to('portal#/#'), "role_perm" => array("adminTasks.frontendCMS")),
