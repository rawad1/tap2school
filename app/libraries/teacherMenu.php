...
$menu = array(
    ...
    "school" => array("title" => "School", "icon" => "mdi mdi-briefcase",
        "children" => array(
            "paycheck" => array("title" => "Paychecks/ deductions", "url" => URL::to('portal#/#'), "role_perm" => array("classes.list"), "icon" => "mdi mdi-chart-areaspline", "activated" => "reportsAct"),
...
//            "invemtory" => array("title" => "Inventory", "url" => URL::to('portal#/#'), "role_perm" => array("Incomes.list"), "icon" => "mdi mdi-chart-areaspline", "activated" => "reportsAct"),
    ...
    "schedule" => array("title" => "Schedule", "icon" => "mdi mdi-calendar-clock",
        "children" => array(
//            "agenda" => array("title" => "Agenda", "url" => URL::to('portal#/agenda'), "role_perm" => array("studyMaterial.list", "homework.list", "assignments.list"), "icon" => "mdi mdi-chart-areaspline", "activated" => "reportsAct"),
