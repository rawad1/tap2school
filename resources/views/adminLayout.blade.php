...
<html lang="en" <?php if ($panelInit->isRTL == 1) { ?>dir="rtl"<?php } ?>>
    ...
    <body class="fix-header <?php
    if ($panelInit->settingsArray['leftmenuScroller'] == "e") {
        echo "fix-sidebar";
    }
    ?> card-no-border" ng-app="OraSchool" ng-controller="mainController">
        <!-- ============================================================== -->
        ...
        <div id="main-wrapper">
            ...
            <!-- ============================================================== -->
            <aside class="left-sidebar <?php
            if ($panelInit->settingsArray['leftmenuScroller'] == "e") {
                echo "enableSlimScroller";
            } else {
                echo "menuTraditional";
                if ($panelInit->isRTL == 1) {
                    echo " menuTraditionalRTL ";
                }
            }
            ?> no-print" style="padding-bottom:20px;">
                <!-- Sidebar scroll-->
                <div class="scroll-sidebar" >
                    <!-- Sidebar navigation-->
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav" <?php
                        if ($panelInit->settingsArray['leftmenuScroller'] != "e") {
                                ...
                                foreach ($panelInit->panelItems as $key => $value) {
                                    ...
                                    if (isset($value['children'])) {
                                        ...
                                        foreach ($value['children'] as $key2 => $value2) {
                                            ...
                                            if (isset($value2['ng-click'])) {
                                                echo " ng-click='" . $value2['ng-click'] . "'";
                                            }
                                            echo ">";
